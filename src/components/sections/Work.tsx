        ...
        <div className="space-y-6">
          {caseStudies.map((project) => (
            <article
              ...
              className="group flex flex-col overflow-hidden rounded-lg border border-border bg-card transition-[border-color,transform] hover:border-accent/50 motion-safe:hover:-translate-y-0.5 md:flex-row"
            >
